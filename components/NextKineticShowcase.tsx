  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="absolute w-[96vw] sm:w-[94vw] max-w-7xl h-[80vh] sm:h-[78vh] rounded-none overflow-hidden bg-black border border-black/10 z-30 opacity-0 transform-gpu pointer-events-auto"
      >
        <video
